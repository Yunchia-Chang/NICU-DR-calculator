...
# =============================================================================
# 🎯 TAB 3: DART.BURST (⚡ 已完全重構 HTML 字串拆解，消滅 f-stringunterminated 核心語法衝突)
# =============================================================================
with tab3:
    if not has_input:
        ...
        with bpd_col1:
            with st.container(border=True):
                ...
                # 🛠️ 拆分封裝，用最標準的語法完美閃避 f-string 多行引號大亂鬥
                st.markdown("<p style='margin:1px 0; font-size:14px; color:#888;'>• <b>Stage I</b> (1mg/kg/dose Q6H 2 days):</p>", unsafe_allow_html=True)
                st.markdown(f"<p style='margin:0 0 10px 0; font-size: 20px; font-weight: bold; color: #1E88E5;'>{burst_dose:.2f} <span style='font-size:12px; color:#fff; font-weight:normal;'>mg/dose</span> &nbsp;<span style='color:#555; font-weight:normal;'>|</span>&nbsp; <span style='color:#F4511E; font-size:16px;'>Q6H</span> &nbsp;<span style='color:#555; font-weight:normal;'>|</span>&nbsp; <span style='color:#4CAF50; font-size:16px;'>2 days</span></p>", unsafe_allow_html=True)
                
                st.markdown("<p style='margin:1px 0; font-size:14px; color:#888;'>• <b>Stage II</b> (1mg/kg/dose Q12H 2 days):</p>", unsafe_allow_html=True)
                st.markdown(f"<p style='margin:0 0 10px 0; font-size: 20px; font-weight: bold; color: #1E88E5;'>{burst_dose:.2f} <span style='font-size:12px; color:#fff; font-weight:normal;'>mg/dose</span> &nbsp;<span style='color:#555; font-weight:normal;'>|</span>&nbsp; <span style='color:#F4511E; font-size:16px;'>Q12H</span> &nbsp;<span style='color:#555; font-weight:normal;'>|</span>&nbsp; <span style='color:#4CAF50; font-size:16px;'>2 days</span></p>", unsafe_allow_html=True)
                
                st.markdown("<p style='margin:1px 0; font-size:14px; color:#888;'>• <b>Stage III</b> (1mg/kg/dose QD 2 days):</p>", unsafe_allow_html=True)
                st.markdown(f"<p style='margin:0; font-size: 20px; font-weight: bold; color: #1E88E5;'>{burst_dose:.2f} <span style='font-size:12px; color:#fff; font-weight:normal;'>mg/dose</span> &nbsp;<span style='color:#555; font-weight:normal;'>|</span>&nbsp; <span style='color:#F4511E; font-size:16px;'>QD</span> &nbsp;<span style='color:#555; font-weight:normal;'>|</span>&nbsp; <span style='color:#4CAF50; font-size:16px;'>2 days</span></p>", unsafe_allow_html=True)
        ...
        with bpd_col2:
            with st.container(border=True):
                ...
                st.markdown("<p style='margin:1px 0; font-size:14px; color:#888;'>• <b>Stage I</b> (0.15mg/kg/day 3 days):</p>", unsafe_allow_html=True)
                st.markdown(f"<p style='margin:0 0 10px 0; font-size: 20px; font-weight: bold; color: #1E88E5;'>{dart_s1:.3f} <span style='font-size:12px; color:#fff;'>mg/dose</span> &nbsp;<span style='color:#555; font-weight:normal;'>|</span>&nbsp; <span style='color:#F4511E; font-size:16px;'>Q12H</span> &nbsp;<span style='color:#555; font-weight:normal;'>|</span>&nbsp; <span style='color:#4CAF50; font-size:16px;'>3 days</span></p>", unsafe_allow_html=True)
                
                st.markdown("<p style='margin:1px 0; font-size:14px; color:#888;'>• <b>Stage II</b> (0.1mg/kg/day 3 days):</p>", unsafe_allow_html=True)
                st.markdown(f"<p style='margin:0 0 10px 0; font-size: 20px; font-weight: bold; color: #1E88E5;'>{dart_s2:.3f} <span style='font-size:12px; color:#fff;'>mg/dose</span> &nbsp;<span style='color:#555; font-weight:normal;'>|</span>&nbsp; <span style='color:#F4511E; font-size:16px;'>Q12H</span> &nbsp;<span style='color:#555; font-weight:normal;'>|</span>&nbsp; <span style='color:#4CAF50;'>3 days</span></p>", unsafe_allow_html=True)
                
                st.markdown("<p style='margin:1px 0; font-size:14px; color:#888;'>• <b>Stage III</b> (0.05mg/kg/day 2 days):</p>", unsafe_allow_html=True)
                st.markdown(f"<p style='margin:0 0 10px 0; font-size: 20px; font-weight: bold; color: #1E88E5;'>{dart_s3:.3f} <span style='font-size:12px; color:#fff;'>mg/dose</span> &nbsp;<span style='color:#555; font-weight:normal;'>|</span>&nbsp; <span style='color:#F4511E; font-size:16px;'>Q12H</span> &nbsp;<span style='color:#555; font-weight:normal;'>|</span>&nbsp; <span style='color:#4CAF50; font-size:16px;'>2 days</span></p>", unsafe_allow_html=True)
                
                st.markdown("<p style='margin:1px 0; font-size:14px; color:#888;'>• <b>Stage IV</b> (0.02mg/kg/day 2 days):</p>", unsafe_allow_html=True)
                st.markdown(f"<p style='margin:0; font-size: 20px; font-weight: bold; color: #1E88E5;'>{dart_s4:.3f} <span style='font-size:12px; color:#fff;'>mg/dose</span> &nbsp;<span style='color:#555; font-weight:normal;'>|</span>&nbsp; <span style='color:#F4511E; font-size:16px;'>Q12H</span> &nbsp;<span style='color:#555; font-weight:normal;'>|</span>&nbsp; <span style='color:#4CAF50; font-size:16px;'>2 days</span></p>", unsafe_allow_html=True)
        with bpd_col3:
            with st.container(border=True):
                ...
                st.markdown("<p style='margin:1px 0; font-size:14px; color:#888;'>• <b>Stage I</b> (1 mg/kg/day Q12h 7 days):</p>", unsafe_allow_html=True)
                st.markdown(f"<p style='margin:0 0 8px 0; font-size: 20px; font-weight: bold; color: #1E88E5;'>{hydro_dose:.2f} <span style='font-size:12px; color:#fff;'>mg/dose</span> &nbsp;<span style='color:#555; font-weight:normal;'>|</span>&nbsp; <span style='color:#F4511E; font-size:16px;'>Q12H</span> &nbsp;<span style='color:#555; font-weight:normal;'>|</span>&nbsp; <span style='color:#4CAF50; font-size:16px;'>7 days</span></p>", unsafe_allow_html=True)
                
                st.markdown("<p style='margin:1px 0; font-size:14px; color:#888;'>• <b>Stage II</b> (0.5mg/kg/day QD for 3 days):</p>", unsafe_allow_html=True)
                st.markdown(f"<p style='margin:0 0 10px 0; font-size: 20px; font-weight: bold; color: #1E88E5;'>{hydro_dose:.2f} <span style='font-size:12px; color:#fff;'>mg/dose</span> &nbsp;<span style='color:#555; font-weight:normal;'>|</span>&nbsp; <span style='color:#F4511E; font-size:16px;'>QD</span> &nbsp;<span style='color:#555; font-weight:normal;'>|</span>&nbsp; <span style='color:#4CAF50; font-size:16px;'>3 days</span></p>", unsafe_allow_html=True)
